...
public class SystemController {
    ...
    private static Properties openProperties(File propsFile){
        Properties props = new Properties();
        if(propsFile.exists() && !propsFile.isDirectory()){
            System.out.println("File Exists");
        }
        else{
            System.out.println("Defaults File Does not Exist, Creating it");
            try{
                propsFile.getParentFile().mkdirs();
                propsFile.createNewFile();
                System.out.println("Defaults File Created");
                ...
                System.out.println("Could not creat defaults file: " + iOE.getMessage());
            }
            catch (Exception e){
        ...
        try{
            ...
            System.out.println("Defaults file not Found: "+fNFE.getMessage());
        }
        catch (IOException iOE){
    ...
    private static void closeProperties(Properties props, File propsFile){
        try{
            FileOutputStream propsFOS = new FileOutputStream(propsFile);
            props.store(propsFOS, "---no comment---");
            propsFOS.close();
        }
        catch (SecurityException sE){
            System.out.println("Security Exception: " + sE.getMessage());
