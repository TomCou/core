...
void loop()                       // run over and over again
{
 ...
 // Movement Controls   
    if (inByte == 0x01){
     // Serial.println("Robot 5: Forward");
    ...
    if (inByte == 0x02){
     // Serial.println("Robot 5: Reverse");
      digitalWrite(enaPin,HIGH);
      digitalWrite(enbPin,HIGH);
    ...
    if (inByte == 0x04){
     // Serial.println("Robot 5: Spin Clockwise");
      digitalWrite(enaPin,HIGH);
      digitalWrite(enbPin,HIGH);
      digitalWrite(onefwPin,LOW);
      digitalWrite(onerwPin,HIGH);
    ...
    if (inByte == 0x03){
     // Serial.println("Robot 5: Spin Counterclockwise");
      digitalWrite(enaPin,HIGH);
      digitalWrite(enbPin,HIGH);
      digitalWrite(onefwPin,HIGH);
      digitalWrite(onerwPin,LOW);
...
//  Advanced Movement Controls
      if (inByte == 0x09){
     // Serial.println("Robot 5: Drive 1 Forward");
      digitalWrite(enaPin,HIGH);
      ...
      if (inByte == 0x0A){
      // Serial.println("Robot 5: Drive 1 Reverse");
      digitalWrite(enaPin,HIGH);
      digitalWrite(enbPin,LOW);
      digitalWrite(onefwPin,LOW);
      digitalWrite(onerwPin,HIGH);
      ...
      if (inByte == 0x0B){
      // Serial.println("Robot 5: Drive 2 Forward");
      ...
      if (inByte == 0x0C){
       // Serial.println("Robot 5: Drive 2 Reverse");
      digitalWrite(enaPin,LOW);
      digitalWrite(enbPin,HIGH);
      digitalWrite(onefwPin,LOW);
      digitalWrite(onerwPin,LOW);
...
// AUX Controls
    if (inByte == 0x05){
     // Serial.println("Robot 5: AUX1 Clockwise");
    ...
    if (inByte == 0x06){
     // Serial.println("Robot 5: AUX1 Counterclockwise");
      digitalWrite(auxEnaPin,HIGH);
      digitalWrite(auxEnbPin,LOW);
    ...
    if (inByte == 0x07){
     // Serial.println("Robot 5: AUX2 Clockwise");
    ...
    if (inByte == 0x08){
     // Serial.println("Robot 5: AUX2 Counterclockwise");
      digitalWrite(auxEnaPin,LOW);
      digitalWrite(auxEnbPin,HIGH);
      digitalWrite(auxOnefwPin,LOW);
      digitalWrite(auxOnerwPin,LOW);
